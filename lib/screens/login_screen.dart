...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _requestOTP() async {
    ...
    try {
      // طلب الكود
      final success = await _authService.requestPhoneVerification(phone);
      
      if (success && mounted) {
        // الذهاب لشاشة التحقق ثم Username
        Navigator.push(
          context,
          MaterialPageRoute(
        ...
        setState(() => _error = 'خطأ في الحصول على الكود');
      }
    } catch (e) {
      if (mounted) {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(
                      'سنرسل كود التحقق إلى رقم الهاتف',
                      style: TextStyle(
                        fontSize: 13,
                        fontFamily: 'Cairo',
                        color: Colors.grey.shade600,
