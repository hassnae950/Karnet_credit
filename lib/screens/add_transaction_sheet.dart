          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: _buildTypeButton('أخذت (عليه)', 'CREDIT', 
                        const Color(0xFFD32F2F), const Color(0xFFFFEBEE)),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: _buildTypeButton('أعطيت (له)', 'PAYMENT',
              ...
              CheckboxListTile(
                title: const Text('هذه المعاملة بشيك', style: TextStyle(fontFamily: 'Cairo')),
                value: _isCheque,
                onChanged: (val) {
              ...
              if (_isCheque) ...[
                ...
                const SizedBox(height: 8),
                ListTile(
                  title: const Text('تاريخ الاستحقاق', style: TextStyle(fontFamily: 'Cairo')),
                  subtitle: _chequeDate != null
                      ? Text(formatDate(_chequeDate!), style: const TextStyle(fontFamily: 'Cairo'))
                      : const Text('اختر التاريخ', style: TextStyle(fontFamily: 'Cairo')),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _isLoading
                      ...
                      : Text(
                          _transactionType == 'CREDIT' ? 'تسجيل كريدي' : 'تسجيل دفعة',
                          style: const TextStyle(
                            color: Colors.white,
                            fontSize: 16,
                            fontFamily: 'Cairo',
    ...
    try {
      if (_transactionType == 'CREDIT') {
        ...
        if (openCredits.isEmpty) {
          _showError('لا يوجد كريدي مفتوح لهذا العميل');
