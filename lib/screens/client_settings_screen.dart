...
class _ClientSettingsScreenState extends State<ClientSettingsScreen> {
  ...
  Future<void> _loadSettings() async {
    ...
    setState(() {
      _notifications =
          prefs.getBool('notif_${widget.client.id}') ?? true;
      _language =
          prefs.getString('lang_${widget.client.id}') ?? 'ar';
      _theme =
          prefs.getString('theme_${widget.client.id}') ?? 'light';
    });
  }
      ...
      body: ListView(
        ...
        children: [
          ...
          _card(children: [
            ...
            _divider(),
            _themeOption(Tr.s('system'), 'system', Icons.phone_android_outlined),
          ]),
  ...
  // ── Theme tile ────────────────────────────────────────────────────────────────
  Widget _themeOption(
      String label, String mode, IconData icon) {
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            style:
                TextButton.styleFrom(foregroundColor: _kRed),
